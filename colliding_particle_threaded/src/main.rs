...
impl ParticleSystem {
    ...
    pub fn simulate_particles(&self) -> (usize, usize) {
        ...
        let total_collisions = Arc::new(Mutex::new(0));
                ...
                for i in 0..NUM_OF_THREADS {
                    ...
                    scope.execute(move || {
                        ...
                        for slice in particles.chunks(NUM_OF_CHUNKS) {
                            *collisions += thread_main_collisions(slice, i);
                        }
                    });
                }
            });
        ...
        let final_collisions = *total_collisions.lock().unwrap();
...
fn thread_main_collisions(list: &[Particle], thread_id: usize) -> usize {
